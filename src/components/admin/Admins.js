        ...
        return (
            <div>    
              ...
              <div className={classes.menu}>
                ...
                <AdminAdd stateRefresh={this.stateRefresh} />
              </div>
    ...
    render() {        
        return (
            <TableRow className={this.props.tableRow}>
                ...
                <TableCell className={this.props.tableBody}><img src={this.props.image} alt="" className={this.props.img}/></TableCell>
                <TableCell className={this.props.tableBody}>{this.props.name}</TableCell>
                <TableCell className={this.props.tableBody}>
                  {(this.props.session_id*1 === this.props.id || this.props.session_id*1 === 1) ?

...
class Data extends React.Component {
  ...
  scroll(n){
    if(n === 1)
      ...
      $('.tabs').css('height','970px')
    else
      $('.tabs').css('height','720px')
  }
      ...
      <div className="data_wrap">
        <div className="top_view">
          <div className="circle_view">
            <img src={this.props.image} alt="profile"  className="profile_img"/>
          </div>
        ...
        <div className="bot_view">
          ...
          <div onClick={this.display_tab3} name="tab3">
            <RoomIcon/>
            <div className="cursor">출결 관리</div>
          </div>
        </div>
        <Divider />
        <div className="tabs">
    ...
    render() {
        return (
            <div>    
              ...
              <TextField className={this.props.box} label="직업" type="text" name="job" value={this.state.job} onChange={this.handleValueChange} /><br/>

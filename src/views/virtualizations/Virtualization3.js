        ...
        <div className="article">
          <div className="article_top">
            ...
            <div>
              <div className="highlight">
                소프트웨어 정의 데이터 센터의 핵심 구성요소 :
                <br className="mobile" /> VMware vSAN
              </div>
          ...
          <div className="article_mid">
            ...
            <div>
              ...
              인프라 솔루션을 구현합니다.
              <br className="pc" /> 포괄적인 소프트웨어 솔루션 제품군을 통해
              간편하게 IT 환경을 확장할 수 있는 대응력을 제공하며,
              <br className="pc" /> 업계 표준 x86 서버와 구성요소로 실행되므로

          ...
          <div className="article_mid2 paper_wide paper_wide_left">
            <Paper elevation={0} className="paper">
              ...
              <div>
                ...
                네트워크 연결형 저장소 솔루션입니다.
                <br /> RX418 확장 유닛 한 대를 연결하면 RS1219+는 드라이브 를
                최대 12개까지 지원하므로, 필요에 따라 간편하게 확장할 수
                있습니다. RS1219+ 와 RX418 모두 깊이가 12인치이므로, 두 장치를
                2포스트 랙에 장착할 수 있습니다. 10GbE 애드온 카드 외에 PCle
                슬롯 또한 SSD 캐시로 작동하는 M.2 SATA SSD 어댑터 카드(옵션)를
                지원하므로, 3.5" 드라이브 베이를 사용하지 않고도 저장소 성능이
                크게 향상됩니다. <br />
                RS1219+에는 쿼드 코어 프로세서와 2GB DDR3 메모리(16GB까지 확장
                가능)가 탑재되어 있습니다. 10GbE 네트워크 환경에서 RS1219+는
                1,310 MB/s 이상의 읽기와 470 MB/s 이상의 쓰기라는 뛰어난 순차
                처리량 성능을 제공합니다.
              </div>
            </Paper>
            <Paper elevation={0} className="paper">
              ...
              <div>
                ...
                기능을 모두 갖추고 있습니다. <br /> Windows® AD 및 LDAP를
                지원하므로, 기존 비즈니스 디렉토리 서비스와 손쉽게 통합될 수
                있습니다. <br /> Windows ACL을 지원하므로, 세부적인 액세스
                제어와 효율적인 권한 설정이 가능합니다. 이를 활용하여 RS1219+를
                기존 인프라에 원활하게 적용할 수 있습니다. <br />
                암호화된 FTP 서버와 웹 기반 파일 탐색기, Synology File
                Station으로 인터넷 파일 액세스가 더욱 간소화되었습니다. HTTPS,
                방화벽 및 IP 자동 차단을 지원하므로, 인터넷을 통해 공유된 파일이
                높은 수준의 보안으로 보호됩니다. <br /> 응용 프로그램 권한은
                각각의 개인 계정, 사용자 그룹 또는 IP 주소를 기반으로 응용
                프로그램 및 패키지로의 액세스를 제어합니다.
              </div>
            </Paper>
          </div>
          <div className="article_mid2">
          ...
          <div className="article_mid2 paper_wide">
            <Paper elevation={0} className="paper">
              ...
              <div>
                ...
                사용자 인터페이스와 우수한 성능의 저장소 기술을 통해 모든 장치의
                중요 데이터를 보호합니다.
              </div>
            </Paper>
          </div>

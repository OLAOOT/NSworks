  ...
  render() {
      ...
      const filteredComponents = (data) => {
        return data.reverse().map((c) => {
          return <BoardList stateRefresh={this.stateRefresh} tableRow= {classes.tableRow} tableBody= {classes.tableBody} key={c.id} id={c.id} c={c} />
        });
      }
      return (
          <div>
  ...
  render() {
    ...
    return (
        <TableRow className={this.props.tableRow}  id="row">
          ...
          <TableCell className={this.props.tableBody} >{this.props.c.content}</TableCell>
        </TableRow>
